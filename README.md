...
5 | Given an integer array that contains every number even number of times, except one number. Find that number. | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Bitwise%20Algorithms/05.cpp) | 20-05-19 | [:page_facing_up:](https://www.geeksforgeeks.org/find-the-number-occurring-odd-number-of-times/)
6 | Given an integer array that contains every number even number of times, except 2 numbers. Find the 2 numbers. | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Bitwise%20Algorithms/06.cpp) | 21-05-19 | [:page_facing_up:](https://www.geeksforgeeks.org/find-the-two-numbers-with-odd-occurences-in-an-unsorted-array/)
...
10 | Given a number N determine the XOR of all numbers from 1 to N WITHOUT using Loops | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Bitwise%20Algorithms/10.cpp) | 21-05-19 | [:page_facing_up:](https://www.geeksforgeeks.org/calculate-xor-1-n/)
