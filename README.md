...
6<br><br>7 :bulb: | Trapping Rainwater (Naive Approach) O(n^2)<br><br>Trapping Rainwater (Efficient Approach) O(n) | [C++](https://github.com/shiv-1998/DS-Algorithms/blob/master/Arrays/06.cpp)<br><br>[C++](https://github.com/shiv-1998/DS-Algorithms/blob/master/Arrays/07.cpp)  [JAVA](https://github.com/shiv-1998/DS-Algorithms/blob/master/Arrays/42%20Trapping%20Rain%20Water.java) | 26-05-19<br><br>26-05-19 | -<br><br>-
...
16 | [Find Triplets with 0 Sum](https://practice.geeksforgeeks.org/problems/find-triplets-with-zero-sum/1/?track=SPC-Sorting&batchId=135) | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Sorting/Find%20Triplets%20with%200%20Sum.java) | 03-02-2020 | (LEARNT=> How to use 2 pointer technique)
...
19 | [Sort by Absolute Difference](https://practice.geeksforgeeks.org/problems/sort-by-absolute-difference/1/?track=SPC-Sorting&batchId=135) | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Sorting/Sort%20by%20Absolute%20Difference.java) | 04-02-2020 | (LEARNT=> Sort an array based on another array using Comparator Interface)
20 | [Triplet Sum in Array](https://practice.geeksforgeeks.org/problems/triplet-sum-in-array/1/?track=SPC-Sorting&batchId=135) | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Sorting/Triplet%20Sum%20in%20Array.java) | 04-02-2020 | (LEARNT=> How to use 2 pointer technique)
...
S.No. | Problem | Solution | Date | References
--- | --- | --- | --- | ---
1 | Given an array find the most frequent element. | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Hashing/01.cpp) | 02-08-19 | -
...
5 | Implement 2 Stacks in an Array | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Stack/05.cpp) | 16-07-19 | -
...
8 | Next Greater Element | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Stack/08.cpp) | 18-07-19 | -
...
S.No. | Problem | Solution | Date | References
--- | --- | --- | --- | ---
1 | DFS Traversal(Java) | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Trees/BinaryTree.java) | 03-10-19 | -
2 | BFS or Level Order Traversal (Java) | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Trees/BinaryTreeBFS.java) | 13-11-19 | -
3 | Given a Binary Tree, print it's level order traversal such that each level is in new line | [:key:](https://github.com/shiv-1998/DS-Algorithms/blob/master/Trees/BFS_Line_By_Line.java) | 14-11-19 | -
